  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Main Card Container */}
        <div className="relative rounded-3xl p-6 sm:p-12 lg:p-16 text-white overflow-hidden shadow-2xl bg-gradient-to-br from-[#011B51] via-[#022870] to-[#001035] border border-white/10">
          ...
          <div className="absolute -right-24 -bottom-24 w-[400px] h-[400px] bg-[#A51A21]/20 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -left-24 -top-24 w-[350px] h-[350px] bg-[#022870]/40 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-6 text-left space-y-6">
              ...
              <p className="text-sm sm:text-base font-semibold text-white/85 leading-relaxed max-w-xl">
              ...
              {/* Corrected Google Play Badge Sizing */}
              <div className="pt-2 flex flex-wrap items-center gap-4">
                ...
                <span className="text-[11px] font-extrabold text-white uppercase tracking-wider bg-white/10 px-4 py-3.5 rounded-xl border border-white/15 backdrop-blur-md">
            ...
            <div className="lg:col-span-6 flex justify-center items-center py-8 lg:py-0">
              ...
              {/* Outer Boundary Box for Absolute Badges */}
              <div className="relative p-6 sm:p-10">
                
                {/* Phone Frame */}
                <div className="relative w-[260px] xs:w-[280px] sm:w-[290px] h-[530px] xs:h-[560px] sm:h-[580px] bg-black border-[10px] border-gray-900 rounded-[2.8rem] shadow-2xl overflow-hidden flex flex-col z-10">
                  
                  {/* Camera Notch */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-28 h-4 bg-gray-900 rounded-b-xl z-30" />
                ...
                <div className="absolute top-10 left-[68%] sm:left-[72%] bg-white text-[#011B51] p-3 sm:p-3.5 rounded-2xl shadow-2xl border border-gray-100 flex items-center space-x-3 w-max z-20 pointer-events-none">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-emerald-50 rounded-xl flex items-center justify-center shrink-0">
                    <CheckCircle2 className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-emerald-600 stroke-[2.5]" />
                  </div>
                  <div className="text-left leading-tight">
                    <p className="text-[10px] sm:text-[11px] font-extrabold text-[#011B51]">GPS Verified</p>
                    <p className="text-[8px] sm:text-[9px] text-gray-500 font-semibold">Inside Room Radius</p>
                  </div>
                </div>

                {/* Floating Status Badge 2 (Bottom Left Offset Clearance) */}
                <div className="absolute bottom-10 right-[68%] sm:right-[72%] bg-white text-[#011B51] p-3 sm:p-3.5 rounded-2xl shadow-2xl border border-gray-100 flex items-center space-x-3 w-max z-20 pointer-events-none">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-amber-50 rounded-xl flex items-center justify-center shrink-0">
                    <ShieldCheck className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-[#A51A21] stroke-[2.5]" />
                  </div>
                  <div className="text-left leading-tight">
                    <p className="text-[10px] sm:text-[11px] font-extrabold text-[#011B51]">Key Bound</p>
                    <p className="text-[8px] sm:text-[9px] text-gray-500 font-semibold">Device Signature Secured</p>
                  </div>
                </div>
